...
Note that, since we work with discrete distributions, the exact required VaR may not be achievable. In that case, `stress_VaR` will return scenario weights inducing the largest quantile in the dataset smaller or equal to the required VaR $q$; this guarantees that $P^W(X_j\leq q)=\alpha$.
