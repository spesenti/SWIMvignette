...
title: Scenario Weights for Importance Measurement (SWIM) -- an `R` package for sensitivity
  analysis
author: Silvana M. Pesenti^[silvana.pesenti@utoronto.ca]^1, Alberto Bettini^2, Pietro
  Millossovich^3,4^, Andreas Tsanakas^4
date: ^1^University of Toronto, ^2^Assicurazioni Generali S.p.A, ^3^DEAMS, University
  of Trieste, ^4^Cass Business School, City, University of London
output: pdf_document
