...
plot_weights(stress.credit, xCol = "L", wCol = 1)
# parameter `wCol` specifies the stresses, whose scenario weights are plotted.
plot_weights(stress.credit, xCol = "L", wCol = 2)
# or plotting both scenario weights in one plot
plot_weights(stress.credit, xCol = "L", wCol = "all", y_limits = c(0, 10))
```
