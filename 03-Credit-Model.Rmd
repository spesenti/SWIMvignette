...
```{r, CM-histL, cache = TRUE, fig.cap = "Histogram of the portfolio loss $L$ under the baseline and the two stressed models.", out.width = '60%', fig.align = 'center'}
...
```{r, CM-joint-stress-VaR-2-effect, echo = TRUE, cache = TRUE, fig.cap = "Quantiles of the aggreagte loss $L$ under the baseline (blue), the additional stress on the tail of $L_2$ and $L_3$ (red), and the stress on the joint tail of $L_2$ and $L_3$ (green).", out.width = '60%', fig.align = 'center'}
# stressed quantiles
