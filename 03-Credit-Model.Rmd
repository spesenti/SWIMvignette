...
In this section, following a reverse sensitivity approach, we study the effects that stresses on (the tail of) the aggregate portfolio have on the three subportfolios. Through this analysis, we aim to assess the comparative importance of the three sub-portfolios.
...
VaR_stressed(object = stress.credit, alpha = c(0.9, 0.9), xCol = "L", base = TRUE)
ES_stressed(object = stress.credit, alpha = c(0.9, 0.9), xCol = "L", base = TRUE)
```

++++ have to amend ES_stressed and VaR_stressed to work with scalar alpha +++
...
```{r, plotting-stresses, cache = TRUE, include = TRUE, echo=TRUE, warning = FALSE, message = FALSE, fig.show='hold', out.width = '50%'}
...
```{r, CM-stress-fixed-VaR, cache = TRUE}
