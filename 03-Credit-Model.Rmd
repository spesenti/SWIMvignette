...
VaR_stressed(object = stress.credit, alpha =  seq(0.8, 0.95, by = 0.05), xCol = "L", wCol = 1, base = TRUE)
...
f.stressH2 <- list(function(x)1 * (x <= VaR.L * 1.2), # indicator function for L, for stress on VaR
                 function(x)x, # mean of H2
                 function(x)1 * (x <= q.H2)) # indicator function for 75th quaantile of H2
...
# probability of joint exceendance under baseline
...
# stressing L2 and L3 as before
# additionally stressing their joint exceedance probability to the level 0.06
f.stress.joint <- list(function(x)1 * (x <= VaR.L2 * 1.2), function(x)1 * (x <= VaR.L3 * 1.2), function(x)1 * (x[1] > VaR.L2 * 1.2) * (x[2] > VaR.L3 * 1.2)) 
