...
```{r, CM-joint-stress-VaR-2-effect, echo = TRUE, cache = TRUE, fig.cap = "Quantiles of the aggregate loss $L$ under the baseline (blue), the additional stress on the tail of $L_2$ and $L_3$ (red), and the stress on the joint tail of $L_2$ and $L_3$ (green).", out.width = '80%', fig.align = 'center'}
# stressed quantiles
